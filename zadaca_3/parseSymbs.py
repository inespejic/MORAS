...
def _parse_macro(self, line, p, o):
    ...
    # izvršava se dok RAM[A] ne postane 0 
        ...
        to_return = ["@" + arg,"D=M", "@TIMES" + str(self.i) ,"M=D", "(Loop_S" + str(self.i) + ")"]
        self.i -= -1
        return to_return
    ...
    # terminira while petlju 
        ...
        self.i -= 1
        return ["@TIMES" + str(self.i), "MD=M-1", "@Loop_E" + str(self.i), "D;JEQ", "@Loop_S"  + str(self.i), "0;JMP", "(Loop_E"  + str(self.i) +  ")"]
