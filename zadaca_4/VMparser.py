...
#   a) 
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            treci_arg= l[2]
            if len(l) == 3 and int(treci_arg) >= 0 and treci_arg.isdigit():
            ...
            treci_arg1= l[2]
            if len(l) == 3 and treci_arg1.isdigit() and int(treci_arg1) >= 0:
                return "//" + " ".join(l) + "\n" + self._pop(l[1], l[2], n)
            else:
                self._flag = False
                Parser._error("Parser", n, "Undefined command");
...
#   b) 
    ...
    def _goto(self, lab, n):
        if lab in self.label: 
            ...
            self._flag= False 
            Parser._error("Parser", n, "Undefined control command.")
            return ""
